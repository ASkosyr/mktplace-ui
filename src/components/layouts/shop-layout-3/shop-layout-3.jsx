...
import { Footer3, FooterContact, FooterCopyright, FooterLinksWidget, FooterSocialLinks } from "components/footer";
...
export default function ShopLayout3({
  ...
  return <Fragment>
      ...
      {showMobileMenu ? <MobileNavigationBar navigation={mobileNavigation.version1} /> : null}
      ...
      {showFooter ? <Fragment>
          <Footer3>
            ...
            <Footer3.Widget2>
              <FooterLinksWidget isDark title="Customer Care" links={footer.customers} />
            </Footer3.Widget2>

            <Footer3.Contact>
              <FooterContact color="inherit" phone={footer.contact.phone} email={footer.contact.email} address={footer.contact.address} />
            </Footer3.Contact>
          </Footer3>
