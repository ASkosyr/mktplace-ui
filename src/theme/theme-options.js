...
import { blue, gold, paste, marron, orange, bluish, primary, success, warning, themeColors } from "./theme-colors";
const THEMES = {
  GIFT: "GIFT",
  HEALTH: "HEALTH",
  DEFAULT: "DEFAULT",
...
export default function themeOptions(pathname) {
  ...
  const selectedMapping = themeMappings.find(mapping => mapping.paths.some(path => pathname.startsWith(path)));
