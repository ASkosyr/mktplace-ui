  ...
  return <Container className="mt-4">
      <RootStyle>
        ...
        <div className="content">
          ...
          <Paragraph mt={1} mb={4} fontSize={{
          md: 16,
          xs: 14
        }}>
            Fashion you can buy, but style you possess. <br /> The key to style
            is learning who you are, which takes years.
          </Paragraph>
