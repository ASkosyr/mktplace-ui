      ...
      <ContentWrapper>
        ...
        backgroundColor: "white"
          ...
          return <div key={index}>
                <CarouselCard2 imgUrl={item.imgUrl} expireDate={expireDate} productName={item.productName} buttonText="BUY NOW" offerName="Deal Of The Day" offerTagline="Fresh Deal Everyday, Get It Now!" offerDescription="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis lobortis consequat eu,
