      ...
      <Grid container spacing={3}>
        ...
        <Grid item lg={3} md={6} xs={12}>
          <Card2 title="Product Share" percentage="10.25%" amount="39.56%">
            <ApexChart height={300} series={[75]} type="radialBar" options={options.productShareChartOptions(theme)} />
          </Card2>
        </Grid>
        ...
        <Grid item lg={3} md={6} xs={12}>
          <Card2 title="Total Order" percentage="2.65%" amount={currency(12260, 0)}>
            <ApexChart type="area" height={100} series={totalOrderSeries} options={options.totalOrderChartOptions(theme)} />
          </Card2>
        </Grid>
        ...
        <Grid item lg={3} md={6} xs={12}>
          <Card2 title="Market Share" percentage="2.65%" amount={currency(14260, 0)}>
            <ApexChart height={300} type="radialBar" series={[44, 55, 67]} options={options.marketShareChartOptions(theme)} />
          </Card2>
        </Grid>
      </Grid>
    </div>;
