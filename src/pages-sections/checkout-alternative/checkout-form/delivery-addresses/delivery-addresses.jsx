  ...
  return <Card sx={{
    ...
    mb: 3
      ...
      <Grid container spacing={3}>
        {deliveryAddresses.map((item, ind) => <Grid item md={4} sm={6} xs={12} key={ind}>
            <AddressCard onClick={() => setFieldValue("address", item.street1)} active={item.street1 === values.address} error={Boolean(touched.address && errors.address)}>
      ...
      {touched.address && <FormHelperText error sx={{
      mt: 2,
      pl: 1
    }}>
          {errors.address}
      ...
      <DeliveryAddressForm open={openModal} handleCloseModal={handleCloseModal} deliveryAddress={editDeliveryAddress} />
    </Card>;
}